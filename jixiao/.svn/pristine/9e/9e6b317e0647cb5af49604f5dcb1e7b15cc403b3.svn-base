...
<html>
  <head>
	...
	<script type="text/javascript" src="/jixiao/js/jquery.jqprint.js" ></script>
	...
	$(function(){
       ...
       $("#jqprint").click(function(){
          $("#jprint").jqprint({ printContainer: true});
       });
	}); 
	</SCRIPT>
  </head>
  ...
  <body>
    <div style="width: 90%;height: 50px;margin: 0 auto;">
          ...
          <div style="font-family: 微软雅黑;font-weight: bolder;font-size: 1.0em;float: left;line-height: 50px;color: #cc2626;">月实绩打印 </div>
          <div style="float: right;font-family: 微软雅黑;font-weight: bolder;font-size: 0.8em;line-height: 50px;">日期：<s:property value="now" /></div>                 
     </div>
    <div style="width: 95%;margin: 0 auto;" id="jprint">
     ...
     <div style="height: 50px;width: 90%;margin: 0 auto;text-align: center;line-height: 50px;">
        <input type="button" value="打印" id="jqprint"/>
     </div>
  </body>
</html>
