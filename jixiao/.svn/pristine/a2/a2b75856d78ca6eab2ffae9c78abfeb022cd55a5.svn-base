...
public class IPSeeker {
	...
	// 保存的文件夹
	private String INSTALL_DIR = "../../../../../../../data";
	...
	public IPSeeker() {
		String filepath = "/" + IPSeeker.class.getResource("/").toString().substring(6) + "QQWry.Dat";
		init(filepath, "");
	}
	...
	public static void main(String[] args) {
		String ip = "119.97.194.170";
		ip = "202.114.32.174";
		ip = "59.175.153.48";
		IPSeeker seeker = new IPSeeker();
		while (true) {
			IPLocation pos = seeker.getIPLocation(ip);
			if (pos != null) {
				System.out.println(pos.getCountry() + "  " + pos.getArea());
			}
		}
